# -*- coding: utf-8 -*-
"""RAG_diseases_docx.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Byg7WqP21WqHRoHOsa81ahXEby_8UxdC
"""
...
# Load the .docx file using LangChain's DocxLoader
loader = Docx2txtLoader("Diseases.docx")

data = loader.load()

data

# Convert docs to Document objects# Convert data to Document objects
...
second_question = "In which disease is it found?"
